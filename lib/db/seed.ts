...
const PARTS: PartTuple[] = [
  ...
  ["MIA-EL-009", "Inverter 1.5kW FR-D720", "Mitsubishi", "Electrical", "Drive", "new_part", "pcs", "A", 1, 3, 1, 2, 2, 3, 5, 3200000, "active", "Aldi Nugroho"],
  ["MIA-EL-010", "Timer Relay H3CR-A", "Omron", "Electrical", "Timer", "consumable", "pcs", "A", 1, 3, 2, 6, 5, 8, 12, 185000, "active", "Budi Santoso"],
  ["MIA-EL-011", "Photoelectric Sensor PQ-RD21", "Keyence", "Electrical", "Sensor", "new_part", "pcs", "A", 1, 3, 3, 0, 3, 5, 8, 2800000, "active", "Aldi Nugroho"],
  ...
  ["MIA-ME-007", "Linear Guide HGH 20CA", "HIWIN", "Mechanical", "Guide", "new_part", "pcs", "B", 1, 2, 3, 2, 2, 4, 6, 1500000, "active", "Aldi Nugroho"],
  ["MIA-ME-008", "Ball Screw SFU1605-500", "TBI Motion", "Mechanical", "Screw", "new_part", "pcs", "B", 1, 2, 4, 1, 1, 2, 4, 2200000, "active", "Candra Putra"],
  ...
  ["MIA-FA-002", "Plate Aluminium A5052 3mm", "Local", "Fabrication", "Plate", "new_part", "lbr", "B", 2, 1, 2, 10, 5, 10, 15, 350000, "active", "Dimas Pratama"],
  ["MIA-FA-003", "Rod Stainless SUS304 Ø10", "Local", "Fabrication", "Rod", "new_part", "btg", "B", 2, 1, 3, 6, 4, 8, 12, 185000, "active", "Aldi Nugroho"],
  ["MIA-FA-004", "Bracket Custom L-Type", "Custom", "Fabrication", "Bracket", "new_part", "pcs", "B", 2, 1, 4, 12, 8, 15, 20, 95000, "active", "Candra Putra"],
  ["MIA-FA-005", "Rubber Pad 50x50x10", "Local", "Fabrication", "Pad", "consumable", "pcs", "B", 2, 2, 1, 22, 10, 20, 30, 22000, "active", "Budi Santoso"],
  ["MIA-UN-001", "Limit Switch TZ-8104", "Tend", "Electrical", "Switch", "new_part", "pcs", null, null, null, null, 0, 5, 8, 12, 65000, "unassigned", "Aldi Nugroho"],
  ["MIA-UN-002", "Hydraulic Seal Kit 40mm", "Parker", "Mechanical", "Seal", "new_part", "set", null, null, null, null, 0, 3, 5, 8, 450000, "unassigned", "Aldi Nugroho"],
